...
use crate::{
    api::{
        ...
        StageInvocationDetail, UI_AGGREGATE_DASHBOARD_ENDPOINT,
    },
...
impl From<&RunningIssueSummary> for UiRunningIssueSummary {
    fn from(issue: &RunningIssueSummary) -> Self {
        Self {
            ...
            agent_routing_reason: issue.agent_routing_reason.clone(),
            agent_routing_label: issue.agent_routing_label.clone(),
...
impl From<&IssueDetailResponse> for UiIssueDetailResponse {
    fn from(issue: &IssueDetailResponse) -> Self {
        Self {
            ...
            preferred_runner_session_id: issue.preferred_runner_session_id.clone(),
            token_metrics: issue.token_metrics.clone(),
            stage_invocations: issue.stage_invocations.clone(),
...
impl From<&RunnerSessionDetail> for UiRunnerSessionDetail {
    fn from(session: &RunnerSessionDetail) -> Self {
        Self {
            ...
            agent_routing_reason: session.agent_routing_reason.clone(),
            agent_routing_label: session.agent_routing_label.clone(),
