      ...
      running_issues: [
        {
          ...
          stage: "review",
          agent: "build",
          agent_routing_reason: "stage_review",
          agent_routing_label: "review gate",
          model: "gpt-5.5",
...
const sym97Issue: IssueDetail = {
  ...
  stage_invocations: [
    {
      fingerprint: "sym-97:implementation",
      state_name: "Implementation",
      selected_agent: "typescript-engineer",
      agent_routing_reason: "frontend_dashboard_update",
      agent_routing_label: "implementation",
      provider: "opencode",
      session_id: "oc-sym-97",
      status: "completed",
      created_at: "2026-06-19T14:00:00Z",
      updated_at: "2026-06-19T14:08:00Z",
    },
    {
      fingerprint: "sym-97:review",
      state_name: "In Review",
      selected_agent: "typescript-reviewer",
      agent_routing_reason: "review_gate",
      agent_routing_label: "review gate",
      provider: "opencode",
      session_id: "oc-sym-97",
      status: "running",
      created_at: "2026-06-19T14:08:00Z",
      updated_at: "2026-06-19T14:12:00Z",
    },
  ],
  token_metrics: tokenMetrics({ total: 38210, cached: 3110, cacheRead: 2800, cacheWrite: 310 }),
  runner_sessions: [
...
const ownerInputIssue: IssueDetail = {
  project_id: "symphony",
  issue_id: "sym-105",
  identifier: "SYM-105",
  title: "Clarify release owner approval",
  lifecycle_stage: "blocked",
  display_status: "owner input required",
  blocker: { kind: "owner_input", message: "human waiting for release owner response", observed_at: "2026-06-19T14:05:00Z" },
  failure: null,
  runtime_defect: null,
  self_defect_routing: null,
  git_ref: null,
  cleanup_status: "pending",
  stop_reason: "owner response required",
  last_runner_event: "owner_input_requested",
  stage_invocations: [
    {
      fingerprint: "sym-105:owner-input",
      state_name: "Owner Input",
      selected_agent: "build",
      agent_routing_reason: "owner_response_required",
      agent_routing_label: "human waiting",
      provider: "opencode",
      session_id: null,
      status: "blocked",
      created_at: "2026-06-19T14:04:00Z",
      updated_at: "2026-06-19T14:05:00Z",
    },
  ],
  token_metrics: tokenMetrics({ total: 0, cached: 0, status: "unavailable" }),
  runner_sessions: [],
...
export const acceptanceProject: ProjectDetail = {
  ...
  active_issues: [sym97Issue, blockedIssue, ownerInputIssue],
  token_metrics: tokenMetrics({ total: 43210, cached: 3110, cacheRead: 2800, cacheWrite: 310 }),
  history_issues: [
    {
      ...sym97Issue,
